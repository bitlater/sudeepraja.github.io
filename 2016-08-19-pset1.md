---
layout: post
title: CS224d course: Problem Set 1
published: true
---
...
Here $$\alpha_w$$ is a scalar for this particular weight, called the learning rate. Its value is decided by the optimization technique used. I highly recommend reading [An overview of gradient descent optimization algorithms](http://sebastianruder.com/optimizing-gradient-descent/) for more information about various gradient decent techniques and learning rates.
